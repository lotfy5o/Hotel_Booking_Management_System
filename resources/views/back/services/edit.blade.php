...
@section('content')
<form action="{{ route('back.services.update', ['service' => $service]) }}" enctype="multipart/form-data" method="POST">
    @csrf
    @method('PATCH')
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            <div class="form-group mb-3">
                ...
                <input type="file" name="image" class="form-control-file" value="{{ $service->image }}">
