        ...
        <div class="card-body">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div class="page-title">
                    <x-action-button href="{{ route('admin.rooms.create') }}" type="create"></x-action-button>
                </div>
            </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.rooms.show', ['room' => $room]) }}" class="btn mb-2 btn-success">{{
                                __('keywords.show_button') }}</a>
                            <a href="{{ route('admin.rooms.edit', ['room' => $room]) }}" class="btn mb-2 btn-warning">{{
                                __('keywords.edit_button') }}</a>

                            <x-delete-button href="{{ route('admin.rooms.show', ['room' => $room]) }}"
