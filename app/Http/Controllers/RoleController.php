...
class RoleController extends Controller
{
    ...
    public function store(RoleRequest $request)
    {
        ...
        return response()->json(['success' => __('keywords.role_created_successfully')]);
    }
    ...
    public function destroy(Role $role)
    {
        $role->syncPermissions();
        $role->delete();
        return to_route('back.roles.index')->with('success', __('keywords.admin_deleted_successfully'));
    }
}
